...
cordw = {'kingw': cords['kingw'], 'quinew': cords['quinew'], 'ladia1w': cords['ladia1w'], 'ladia2w': cords['ladia2w'],
         'defender1w': cords['defender1w'], 'defender2w': cords['defender2w'],
         'horse1w': cords['horse1w'], 'horse2w': cords['horse2w'], 'pawn1w': cords['pawn1w'], 'pawn2w': cords['pawn2w'],
         'pawn3w': cords['pawn3w'], 'pawn4w': cords['pawn4w'],
         'pawn5w': cords['pawn5w'], 'pawn6w': cords['pawn6w'], 'pawn7w': cords['pawn7w'], 'pawn8w': cords['pawn8w']}
